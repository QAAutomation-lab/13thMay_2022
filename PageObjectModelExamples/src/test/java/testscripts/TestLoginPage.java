...
public class TestLoginPage extends SeleniumUtility{
	...
	public void testVtigerLogin() {
		...
		Assert.assertEquals(getCurrentTitleOfApplication("Dashboard"), getValueFromPropertyFile("expectedHomePageTitle"),"Login was not successfull or title got changed");
